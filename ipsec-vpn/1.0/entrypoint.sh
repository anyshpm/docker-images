...
L2TP_NET=${VPN_L2TP_NET:-'10.0.42.0/24'}
L2TP_LOCAL=${VPN_L2TP_LOCAL:-'10.0.42.1'}
L2TP_POOL=${VPN_L2TP_POOL:-'10.0.42.10-10.0.42.250'}
XAUTH_NET=${VPN_XAUTH_NET:-'10.0.43.0/24'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'10.0.43.10-10.0.43.250'}
...
config setup
  virtual-private=%v4:10.0.0.0/8,%v4:172.16.0.0/12,%v4:!$L2TP_NET,%v4:!$XAUTH_NET
  protostack=netkey
